...
function serve( args, createApp ) {
  ...
  var customGenerators = null;
  var requireGenerators = args["require-generators"]

  if (requireGenerators) {
    try {
      customGenerators = require(requireGenerators);
    } catch (e) {
      console.log("Unable to require custom generators");
    }
  }
